    ...
    <>
      ...
      <section className="mx-auto max-w-4xl space-y-4 px-6 pb-20">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="flex items-start gap-3 rounded-xl p-5 ring-1 ring-foreground/5">
            <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-accent/10">
              <Scale className="size-5 text-accent" />
            </div>
            <div>
              <h3 className="text-sm font-semibold">Split Fairly</h3>
          ...
          <div className="flex items-start gap-3 rounded-xl p-5 ring-1 ring-foreground/5">
            ...
            <div>
              <h3 className="text-sm font-semibold">Settle Simply</h3>
              <p className="mt-1 text-xs text-muted-foreground text-pretty">
